...
import time
import pytest
from pages_class.auth_page import AuthPage
from pages_class.register_page import MainPage
from pages_class.auth_page_with_code import AuthPageWithCode
...
def test_negative_authorisation_short_password(web_browser):
    ...
    assert 'https://b2c.passport.rt.ru/account_b2c/page' not in page.get_current_url()
    assert 'Длина пароля не менее 8 символов' in page.get_page_source()
